...
### Bug Fix: 分组管理面板列表项布局修复

**问题:**
- 分组管理面板的分组列表项布局错乱
- 圆点、名称、数量、操作按钮未正确一行展示

**解决方案:**
- 分组列表项使用 flex 布局：圆点 + 名称 + 数量（左）| 编辑 + 删除（右）
- 每项高度 56px，下边框分隔
- 面板最大高度 70vh，超出可滚动

**修改文件:**
- `miniprogram/pages/history/index.wxss` - 修复 .group-item 样式

**Spec 更新:**
- 分组管理面板布局规格已详细定义（分组管理功能章节）
