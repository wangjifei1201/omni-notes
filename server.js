...
{
    "summary": "要准确概括视频主旨，涵盖视频中核心内容",
    "keyPoints": [
        {"point": "核心要点1", "detail": "支撑该要点的详细内容说明，包括具体例子、数据或解释"},
        {"point": "核心要点2", "detail": "支撑该要点的详细内容说明"},
        {"point": "核心要点3", "detail": "支撑该要点的详细内容说明"},
        {"point": "核心要点4", "detail": "支撑该要点的详细内容说明"},
        {"point": "核心要点5", "detail": "支撑该要点的详细内容说明"}
    ],
    "chapters": [
...
要求：
1. summary要准确概括视频主旨，涵盖视频中核心内容（基于纠错后的内容）
2. keyPoints提取5个最有价值的观点，每个要点包含：
   - point: 核心观点（简洁标题）
   - detail: 详细说明（2-4句话解释该观点，使用纠错后的专业术语）
3. chapters划分6-8个章节，time格式MM:SS
